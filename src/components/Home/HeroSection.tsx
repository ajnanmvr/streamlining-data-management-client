            ...
            <section className='px-12 lg:px-20  h-[500px] flex items-center'>
                <div>
                    ...
                    <div className='flex gap-2 font-semibold justify-center lg:justify-start mt-8'>
                        <Link href={"/project"}><button className='hover:bg-light lg:text-lg rounded-lg text-white px-3 py-2 bg-primary border-primary'>Get Started</button></Link>
                ...
                <div><img src="/excel-icon.png" alt="" className='hidden lg:block lg:w-[700px] xl:w-[800px]' /></div>
            </section>
        </div>
    )
}
