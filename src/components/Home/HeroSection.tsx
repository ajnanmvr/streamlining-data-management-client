    ...
    return (
        <div>
            <section className='px-12 lg:px-20  h-[500px] flex items-center'>
                <div>
                    <h1 className='text-center lg:text-left font-extrabold text-[39px] leading-[45px] lg:text-[70px] lg:w-5/6 lg:leading-[80px] xl:text-[100px] xl:leading-[95px]'>Unlock the Power of <span className='text-primary'>Excelens</span>, Anywhere, Anytime!</h1>
